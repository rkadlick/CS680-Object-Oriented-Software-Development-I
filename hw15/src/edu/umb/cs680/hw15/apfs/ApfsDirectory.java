...
public class ApfsDirectory extends ApfsElement {
	...
	public LinkedList<ApfsElement> getChildren(){
		Collections.sort(this.children, Comparator.comparing(ApfsElement::getName));
	...
	public LinkedList<ApfsDirectory> getSubDirectories(){
		...
		Collections.sort(subDirectories, Comparator.comparing(ApfsElement::getName));
	...
	public LinkedList<ApfsFile> getFiles(){
		...
		Collections.sort(files, Comparator.comparing(ApfsElement::getName));
		return files;
	...
	public LinkedList<ApfsLink> getLinks(){
		...
		Collections.sort(links, Comparator.comparing(ApfsElement::getName));
		return links;
